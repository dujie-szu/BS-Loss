...
def compute_average_surface_distance(surface_distances):
  ...
  #     np.sum(distances_pred_to_gt * surfel_areas_pred) /
  #     np.sum(surfel_areas_pred))
  # average_surface_distance = (np.sum(distances_gt_to_pred) + np.sum(distances_pred_to_gt)) / (len(distances_gt_to_pred) + len(distances_pred_to_gt))
  average_surface_distance = (np.sum(distances_gt_to_pred * surfel_areas_gt) + np.sum(distances_pred_to_gt * surfel_areas_pred)) / (np.sum(surfel_areas_gt) + np.sum(surfel_areas_pred))
